...
export function totalsHTML(t,complete=true) {return `<div class="summary-line"><span>Items</span><span>${currency(t.subtotal)}</span></div><div class="summary-line"><span>Shipping</span><span>${complete?currency(t.shipping):'At checkout'}</span></div><div class="summary-line"><span>Sales tax (5.3%)</span><span>${complete?currency(t.tax):'At checkout'}</span></div><div class="summary-line total"><span>${complete?'Total':'Subtotal'}</span><span>${currency(complete?t.total:t.subtotal)} USD</span></div>`;}
